    ...
    <QuickstartFramework><div className="quickstart-content">
      ...
      <div id="optional" className="quickstart-optionals"><h2>Add more when you need it</h2>
        ...
        <details id="settings" className="quickstart-details"><summary>7. Add billing settings <small>Optional</small></summary>
          ...
          <p>React bill forms load saved provider and location choices automatically with an organization-wide billing session. Add the separate <code>billingSettings</code> session prop to let administrators add choices from the form. See the <Link href="/guides/practice-settings">practice settings guide</Link> for setup, W-9 attachment, and scoped-session behavior.</p>
        ...
        <details id="rfa" className="quickstart-details"><summary>8. Add RFA components <small>Optional · treatment billing</small></summary>
          <p>For treatment authorization and billing, start with the <Link href="/guides/rfas">prebuilt RFA dashboard</Link> and the <Link href="/learn/treatment-quickstart">treatment billing quickstart</Link>.</p>
        </details>
      </div>
