    ...
    <div className="quickstart-content">
      ...
      <section id="setup"><h2>2. Choose your setup</h2>
        ...
        <QuickstartTabs label="Treatment setup" tabs={[
          { label: "React", content: <><CodeBlock language="bash" filename="Terminal" code="npm install @mindbill/react@0.69.6" /><p>Add the <Link href="/learn/quickstart#auth">backend auth route</Link> for your signed-in users.</p></> },
