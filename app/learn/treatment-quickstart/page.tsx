...
const treatmentFields = `const treatmentBill = {
  ...
  serviceLines: [{
    code: "99213",
    units: 1,
    charge: 150, // Synthetic submitted charge, in dollars.
