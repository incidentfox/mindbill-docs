...
export default function LifecyclePage() {
  return (
    ...
    >
      ...
      <Callout title="Notify your own application users">Use signed webhooks for assigned-doctor notifications and your own delivery. Once enabled for your integration, the separate partner-recipient API can also enroll verified, explicitly consenting practice-wide recipients without a console account. See the <a href="/guides/notifications">notification integration guide</a>. Courtesy-copy recipient options are not notification subscriptions.</Callout>
