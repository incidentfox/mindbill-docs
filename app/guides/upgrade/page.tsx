...
1. Update @mindbill/react to 0.69.4 and any directly installed @mindbill/browser to 0.43.2.
...
export default function UpgradePage() {
  return <DocPage eyebrow="Start here" title="Upgrade an existing integration" description="A short checklist for existing MindBill integrations."
    ...
    <p>Update <code>@mindbill/react</code> to <code>0.69.4</code> and any directly installed <code>@mindbill/browser</code> to <code>0.43.2</code>, update your lockfile, and rebuild your app. Existing <code>ConnectedBillLifecycle</code> and <code>ConnectedBillingWorkspace</code> imports stay the same.</p>
