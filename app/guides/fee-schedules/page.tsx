...
export default function FeeSchedulesPage() {
  return <DocPage eyebrow="Treatment billing" title="California fee calculator"
    ...
    toc={[{ id: "access", label: "Access" }, { id: "component", label: "Embed the calculator" }, { id: "anesthesia", label: "Anesthesia bill fields" }, { id: "api", label: "Quote through the API" }, { id: "results", label: "Read the result" }, { id: "dates", label: "Dates and sources" }, { id: "submission", label: "Submit a treatment bill" }]}
    ...
    <CodeBlock language="bash" filename="Terminal" code="npm install @mindbill/react@0.69.2 @mindbill/browser@0.43.1" />
