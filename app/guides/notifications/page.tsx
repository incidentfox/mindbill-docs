...
export default function NotificationsPage() {
  return <DocPage eyebrow="Build" title="Send useful billing notifications" description="Support users who never sign into the MindBill console, without turning a contact list into an email subscription."
    ...
    <p>Use <code>@mindbill/react@0.62.0</code> and add <code>NotificationRecipientsSettings</code> (alias <code>ConnectedNotificationRecipientsSettings</code>) to your administrator&apos;s billing settings. Enter any authorized email address, choose practice-wide or assigned-bill alerts and optional digests, and send an invitation. The recipient needs no MindBill console account or account in your app.</p>
