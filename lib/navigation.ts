...
export const navigation: DocLink[] = [
  ...
  },
  {
    ...
    label: "Components quickstart",
    description: "Install React or Angular components and connect billing to your app.",
    group: "Start here",
    icon: SquareCode,
    keywords: ["install", "first bill", "rest", "node", "sandbox"],
  },
  {
    href: "/learn/api-quickstart",
    label: "API quickstart",
    description: "Create, track, and manage bills from your backend with the Node SDK.",
    group: "Start here",
    icon: SquareCode,
    keywords: ["sdk", "node", "api", "search", "resubmit"],
  },
  {
    href: "/learn/treatment-quickstart",
    label: "Treatment quickstart",
    description: "Add treatment billing and Request for Authorization workflows.",
    group: "Start here",
    icon: ReceiptText,
    keywords: ["treatment", "professional", "rfa", "authorization"],
  },
  {
    href: "/guides/upgrade",
    label: "Upgrade guide",
